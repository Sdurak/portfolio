...
//             <div className="pb-4">
//               <p className="text-4xl font-bold inline border-b-4 border-gray-500 ml-40">
//                 {textData.basicInfoHeader}
//               </p>
//             </div>
//             <p className="text-xl text-white mt-2 ml-40">
    ...
    <div name={textData.nav2}>
      <div className="flex flex-col md:flex-row bg-gradient-to-b from-gray-800 to-black text-white">
        <div className="w-full md:w-1/2 p-4 md:p-20">
          <div className="max-w-screen-lg mx-auto">
            <div className="pb-4">
              <p className="text-4xl font-bold inline border-b-4 border-gray-500 md:ml-40">
                {textData.basicInfoHeader}
              </p>
            </div>
            <p className="text-xl text-white mt-2 md:ml-40">
              <span>{textData.birthDate}</span>
              <br />
              <span>{textData.city}</span>
              <br />
